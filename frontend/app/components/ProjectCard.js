      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {technologies.map(tech => (
            <span key={tech} className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded-full text-base">
              {tech}
            </span>
          ))}
        </div>
        ...
        <div className="flex gap-4">
          ...
          {githubLink && (
            <Link 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center text-gray-700 hover:text-gray-900 text-lg"
            >
